...
class ZyboPlatform(Xilinx7SeriesPlatform):
    ...
    resources = [
        Resource("hdmi", "north",
             ...
             Subsignal("data_b", DiffPairs("D19", "D20", dir='o'), Attrs(IOSTANDARD="TMDS_33")),
             Subsignal("data_g", DiffPairs("C20", "B20", dir='o'), Attrs(IOSTANDARD="TMDS_33")),
             Subsignal("data_r", DiffPairs("B19", "A20", dir='o'), Attrs(IOSTANDARD="TMDS_33")),
