...
class FT601PerfDebug(Elaboratable):
    def __init__(self, ft601_resource):
        ...
        self.consecutive_counter = Signal(16)
    ...
    def elaborate(self, platform):
        ...
        with m.If(ft.txe):  # we have space in the transmit fifo
            m.d.ft += self.consecutive_counter.eq(self.consecutive_counter + 1)
        ...
        m.d.comb += ft.data.o.eq(Cat(self.consecutive_counter, self.idle_counter))
