    ...
    def __init__(self):
        ...
        self.add_resources([
            Resource("sensor", 0,
                     ...
                     Subsignal("lvds_clk", DiffPairs("51", "53", dir='i', conn=("expansion", 0)), Attrs(IOSTANDARD="LVDS_25", IN_TERM="UNTUNED_SPLIT_50")),
                     Subsignal("lvds", DiffPairsN("41 45 55 65", "43 47 57 67", dir='i', conn=("expansion", 0)), Attrs(IOSTANDARD="LVDS_25", IN_TERM="UNTUNED_SPLIT_50")),
                     ),
            Resource("i2c", 0,
